package com.fegssp.motivation.data
...
class Mock {
    ...
    private val langPt = MotivationConstants.LANG.PT
    private val langEn = MotivationConstants.LANG.ENG
    private val langFr = MotivationConstants.LANG.FRAN
    ...
    fun getPhrase(categoryID: Int, lang:String): String{
        val filtered = mListPhrase.filter {
            (it.categoryID == categoryID || categoryID == all) && it.lang == lang}
